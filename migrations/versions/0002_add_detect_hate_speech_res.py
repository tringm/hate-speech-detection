...
Revision ID: 0002
Revises: 0001
Create Date: 2024-01-20 11:01:23.146963
...
def upgrade() -> None:
    ...
    op.add_column("llm_prompt_run", sa.Column("llm_model_name", sqlmodel.sql.sqltypes.AutoString(), nullable=False))
    op.add_column("llm_prompt_run", sa.Column("llm_model_configs", sa.JSON(), nullable=True))
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_column("llm_prompt_run", "llm_model_configs")
    op.drop_column("llm_prompt_run", "llm_model_name")
