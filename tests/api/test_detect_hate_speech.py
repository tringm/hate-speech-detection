...
def _assert_hate_speech_response(resp: Response, is_hate_speech: bool) -> DetectHateSpeechResponse:
...
async def test_detect_hate_speech_endpoint(
    ...
    db_resp = await db_session.get(DetectHateSpeechResponse, resp_model.uuid)
